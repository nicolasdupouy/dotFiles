...
## Hosts
### Local
HOST_SURESNES_IP='109.7.245.170'
HOST_SURESNES_SSH_PORT=8022
...
# -- Aliases
# Local network
alias alias_SSH_connect_Suresnes_from_outside='ssh -i $PRIVATE_KEY_HOST_LOCAL_LOS_ANGELES_USER_NICOLAS $USER_NICOLAS@$HOST_SURESNES_IP -p $HOST_SURESNES_SSH_PORT'
